...
<div class="flexslider">
    <ul class="slides">
        <c:forEach items="${image}" var="nots">
            <li
...
<div class="new-announcement">
    ...
    <div class="new-announcement-content">
        <div id="scrollDiv">
            <ul style="margin-top: 0px;">
                <v
                <c:forEach items="${listByTop}" var="nots">
                    <li><a class="black-link"
                           href="${pageContext.request.contextPath}/notice/list?noticeid=${nots.noticeid}&&url=inform"
    ...
    <a class="more"
       href="${pageContext.request.contextPath}/notice/list?noticetype=1&&url=inform">更多</a>
</div>
<div class="ipubs">
    ...
    <div class="wrap">
                ...
                <div class="bd">
                    <div class="des">
                        <span class="fn-left">期限1-29天，期限短，收益见效快</span><a
                            href="<%=basePath %>product/list" class="fn-right">查看更多&gt;&gt;</a>
                    </div>
                                ...
                                <li>
                                    <div class="title">
                                        <a target="_blank"><i class="icon icon-zhai"
                                            ...
                                            title="${invest.pname }" target="_blank">
                                        ${invest.pname }<!-- 金女士债权质押借款1万元 --></a>
                                    </div>
                                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                        <tbody>
                                        <tr>
                                            <td width="260">借款金额<span
                                                    class="f24 c-333">${invest.ptotalmoney }<!-- 10000.00 --></span>元
                                            </td>
                                            <td width="165">年利率<span class="f24 c-orange">${invest.pincome }%
                                                <!-- 10.70% -->
													</span></td>
                                    ...
                                    <li>
                                        <div class="title">
                                            <a target="_blank"><i class="icon icon-che"
                                                                  title="车易贷"></i></a><a
                                                href="investInfo.do?bmid=${pro.id }"
                                                class="f18" title="毕先生宝马320汽车质押贷款10万元" target="_blank">
                                            ${pro.pname}<!-- 毕先生宝马320汽车质押贷款10万元 --></a>
                                        </div>
        ...
        <div class="page-right fn-right" style="top: 0px;">
            ...
            <div class="mod mod-notice mrt20">
                <div class="hd">
                    <h3>网站公告</h3>
                    <a href="${pageContext.request.contextPath}/notice/list?noticetype=1&&url=inform" class="fn-right">更多&gt;</a>
                </div>
                <div class="bd">
            ...
            <div class="mod mod-report ui-tab clearfix mrt20">
                ...
                <div class="bd">
                    <div class="ui-tab-cont">
                        <div class="ui-tab-item active">
                            <c:forEach items="${listByMtbd}" var="nots">
                            <div class="headlines">
                                <img src="${nots.noticepicture}"> <a title="${nots.noticetitle }"
                                    target="_blank" href="#">${nots.noticetitle }</a><br> <span
                                    class="des">${nots.noticecontent}</span>
                            </div>
                            </c:forEach>
                                ...
                                <ul>
                                    <c:forEach items="${listByMtbd}" var="nots">
                                        <li><a
                                                ...
                                                title="${nots.noticetitle }" target="_blank">${nots.noticetitle }</a>
                                        </li>
                                    </c:forEach>
                                </ul>
                            </div>--%>

	...
	<section class="wrapper">
		...
		<div class="showback">
			...
			<form class="form-horizontal style-form" method="post"
				  action="<%=basePath%>/hhjbiao/addupdate">
				<div class="form-group">
					<input type="hidden" name="id" value="${id}">
					<label class="col-sm-2 col-sm-2 control-label">标的名称：</label>
					<div class="col-sm-10">
						<span class="help-block">请输入标的名称.(不超过5个汉字)</span>
						<input type="text" class="form-control" name="bname" maxlength="10" value="${bname}">
					</div>
				</div>

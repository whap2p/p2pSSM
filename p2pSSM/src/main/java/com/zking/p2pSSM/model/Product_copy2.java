...
public class Product_copy2 {
    ...
    public Product_copy2(Integer id, Long pmoney, String pincome, Date ptime, Integer ptype, String pway, Date pcount, String progress, String psaveway, String prateben, Date ppublishtime, String pname, Long ptotalmoney, String prange, String puse, String pstate, String picture, Integer pproduce, String pdesc, String psafe, Integer did) {
        this.id = id;
        this.pmoney = pmoney;

...
public class Withdrawal {
    ...
    public Withdrawal(Integer wID, Integer uID, String uname, String zname, String txnum, String txbank, String txmoney, String dzmoney, String sxf, Date txtime, Date zztime, String statu, String shwho, Date shtime, String nothing) {
        this.wID = wID;
        this.uID = uID;
        this.uname = uname;
        this.zname = zname;

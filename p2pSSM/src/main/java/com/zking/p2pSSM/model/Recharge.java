...
public class Recharge {
    ...
    public Recharge(Integer rID, Integer uID, String uname, String czlx, String lsh, String czmoney, String fl, String dzmoney, Date cztime, String statu, String zname) {
        this.rID = rID;
        this.uID = uID;
        this.uname = uname;
        this.czlx = czlx;
